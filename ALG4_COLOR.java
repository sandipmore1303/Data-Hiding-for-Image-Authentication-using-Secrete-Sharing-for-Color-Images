...
public  static void main(String args[])  {      
   ...
   try {
    ...
    //2 convert to grayscale      
     ...
     BufferedImage Binary_i_r = new BufferedImage(image_oi.getWidth(),image_oi.getHeight(),  BufferedImage.TYPE_INT_ARGB);
     int  lim_r,  lim_c;
     ...
     int k=0;
        ...
        for (int cx=0;cx<image_oi.getWidth();cx++) {  
           for (int cy=0;cy<image_oi.getHeight();cy++) { 
             ...
             k++;
              int rgb2=image_oi_r.getRGB(cx, cy); 
             alpha = ((rgb2 >> 24) & 0x000000ff);         
             red=Binary_Image_original_r[cx][cy]*255;
             green=Binary_Image_original_r[cx][cy]*255;
             blue=Binary_Image_original_r[cx][cy]*255;
             rgb2=(alpha << 24) | (red << 16) | (green << 8) | blue;
             Binary_i_r.setRGB(cx, cy, rgb2); 
    ...
    ////////////////////////////////////////////////////////////////////
     ...
     sp_g[1]=sCurrentLine_g.substring(sCurrentLine_g.indexOf(".")+1);
      ...
      parseInt2 = Integer.parseInt(sp_g[1].substring(0,1));
     G_g[0]=(parseInt1+parseInt2/(100000.0));      
         try {  
             sCurrentLine_g = br_g.readLine();
         } catch (IOException ex) {
             Logger.getLogger(ALGO_41.class.getName()).log(Level.SEVERE, null, ex);
     ...
     parseInt1 = Integer.parseInt(sp_g[0]);
     parseInt2 = Integer.parseInt(sp_g[1].substring(0,1));
     G_g[1]=parseInt1+parseInt2/(100000.0);
     //System.out.println("Value of gray level g1="+G[0]);
     //System.out.println("Value of gray level g2="+G[1]);
 ...
 ///*******************************************************************       
  ...
  //**********************************************************************   
     ...
     int BI_r[][]=new int[lim_c][lim_r];
     int BI_mod_r[][]=new int [lim_c][lim_r];
     int AI_r[][]=new int[lim_c][lim_r];
     int AI_mod_r[][]=new int[lim_c][lim_r];
 ...
 int q1_r[]=new int[6];
 int q_r[]=new int[6];
 boolean tampered_blocks_r[][]=new boolean[lim_c][lim_r];
 boolean tampered_shares_r[][]=new boolean[lim_c][lim_r];
 int blk_no=0;
 for (int j=0; j<lim_c  && j%3==0 ;j=j+3)
     for(int i=0; i<lim_r  && i%2==0;i=i+2) 
           { 
...
//*****************************************************************************************************        
             ...
             //3. obtain alpha component  and binary components into 2d array  
     int BI_g[][]=new int[lim_c][lim_r];
     int BI_mod_g[][]=new int [lim_c][lim_r];
     int AI_g[][]=new int[lim_c][lim_r];
     int AI_mod_g[][]=new int[lim_c][lim_r];
 ...
 int q1_g[]=new int[6];
 int q_g[]=new int[6];
 boolean tampered_blocks_g[][]=new boolean[lim_c][lim_r];
 boolean tampered_shares_g[][]=new boolean[lim_c][lim_r];
 blk_no=0;
 for (int j=0; j<lim_c  && j%3==0 ;j=j+3)
     for(int i=0; i<lim_r  && i%2==0;i=i+2) 
           { 
...
//////////////////////////////////////////
     ...
     //3. obtain alpha component  and binary components into 2d array  
     int BI_b[][]=new int[lim_c][lim_r];
     int BI_mod_b[][]=new int [lim_c][lim_r];
     int AI_b[][]=new int[lim_c][lim_r];
     int AI_mod_b[][]=new int[lim_c][lim_r];
 ...
 int q1_b[]=new int[6];
 int q_b[]=new int[6];
 boolean tampered_blocks_b[][]=new boolean[lim_c][lim_r];
 boolean tampered_shares_b[][]=new boolean[lim_c][lim_r];
 blk_no=0;
 for (int j=0; j<lim_c  && j%3==0 ;j=j+3)
     for(int i=0; i<lim_r  && i%2==0;i=i+2) 
           { 
