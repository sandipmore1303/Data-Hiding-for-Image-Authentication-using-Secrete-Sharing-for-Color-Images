...
public class ALG3_COLOR_FINAL_1 {
...
//*********************************************************************************************************************        
  ...
  //System.out.println("Mapping remaining four partial shares of each block of alpha plane to other blocks using key K ...");
        ...
        //System.out.println("\n\nAfter Mapping remaining four partial shares of each block of alpha plane to other blocks using key K ...:");        
         ...
         //BufferedImage stego_color=new BufferedImage(gray_i_r.getWidth(), gray_i_r.getHeight(),  BufferedImage.TYPE_INT_ARGB);
...
///save authentication signal in color format
        ...
        for (int cy = 0; cy < LIM_C; cy++) {
            for (int cx = 0; cx < LIM_RR; cx++) {
                ...
                alpha = 255;
                red=stego_gray_r.getRGB(cy, cx);
                green=stego_Gray_g.getRGB(cy, cx);
                blue=stego_Gray_b.getRGB(cy, cx);
                rgb = (alpha << 24) | (red << 16) | (green << 8) | blue;
          ...
          try {
            ImageIO.write(Authentication_data_color, "png", new File(oi.getDirectory() + "Authentication.png"));
         } catch (IOException e) {}
          try {
