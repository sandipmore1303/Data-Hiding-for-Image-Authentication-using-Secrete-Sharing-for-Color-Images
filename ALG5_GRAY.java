...
public class ALG5_GRAY {
    ...
    JFrame frame_gi = new JFrame("Original image in RGB color space");
    ...
    JFrame frame_bs2 = new JFrame("Original image in YCbCr color space");
    ...
    JFrame frame_bs61 = new JFrame("Authentication Signal");
    Panel panel_bs61 = new ShowImage(oi.getDirectory()+"Authentication_data.jpg");
    frame_bs61.getContentPane().add(panel_bs61);
    frame_bs61.setSize(500, 500);
    frame_bs61.setVisible(true);
    ...
    //System.out.println("doing ...");
      ...
      // BufferedImage stego_color=new BufferedImage(gray_i.getWidth(), gray_i.getHeight(),  BufferedImage.TYPE_INT_ARGB);
       ...
       BufferedImage ad=new BufferedImage(gray_i.getWidth(), gray_i.getHeight(),  BufferedImage.TYPE_INT_ARGB);
     ...
     try {     
      ...
      try {    
       ...
       try {    
        ...
        try {    
          ImageIO.write(ad, "jpg", new File(oi.getDirectory()+"Authentication_data.jpg"));
      }catch (IOException e) {} 
