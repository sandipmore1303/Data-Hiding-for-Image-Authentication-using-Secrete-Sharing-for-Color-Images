...
public class ALG4_GREEN {
    ...
    Panel panel_bs = new ShowImage(oi.getDirectory()+"gray_recovered_g.png");
...
public  static void main(String args[])  {      
   ...
   try {
    ...
    //2 convert to grayscale      
     ...
     int parseInt1 = Integer.parseInt(sp_g[0]);
     int parseInt2 = Integer.parseInt(sp_g[1].substring(0,1));
 ...
 ///*******************************************************************       
     ...
     {
       try {
           K[ii]=Integer.parseInt( br_g.readLine());
       } catch (IOException ex) {
           Logger.getLogger(ALGO_41.class.getName()).log(Level.SEVERE, null, ex);
       }
     }
